...
var fileDescriptor_e0f9056a14b86d47 = []byte{
	...
	,
}
...
func (c *appClient) Hello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	out := new(HelloResponse)
	err := c.cc.Invoke(ctx, "/App/Hello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _App_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/App/Hello",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AppServer).Hello(ctx, req.(*HelloRequest))
	}
